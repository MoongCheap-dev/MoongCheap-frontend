...
const nextConfig: NextConfig = {
  images: {
     ...
     *
     *   배너 393 · 판매자 미리보기 336 · 브랜드딜 260 · 빈 상태 246 · 결제수단 160
     *   상품카드 121 · 와이드 120 · 브랜드행 106 · 행 65 · 주문 60 · 오류 123
     *
     * 목록에 없는 폭을 요청하면 그보다 큰 값으로 올림된다. 원본보다 큰 값으로 올라가면
     * 확대가 일어나므로, 새 화면을 만들 때 표시 폭이 늘면 여기에도 추가한다.
     */
    deviceSizes: [393, 786],
    imageSizes: [60, 65, 106, 121, 130, 160, 212, 242, 260, 320, 336, 492, 520, 672],
