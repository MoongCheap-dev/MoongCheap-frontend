...
// bg·pressed·포커스 링·rounded-full·글자색(기본 content-primary)을 기본으로 깔고,
...
export function Button({ className, type = 'button', ...props }: ButtonProps) {
  return (
    <button
      type={type}
      className={cn(
        'bg-surface-button-secondary-default text-content-primary active:bg-surface-button-secondary-pressed focus-visible:ring-effect-focus-ring-primary rounded-full outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
        className,
      )}
      {...props}
    />
